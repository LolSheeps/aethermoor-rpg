...
**Starting Talent Options:** Butterfly Effect, Cascade Failure, Murphy's Law
...
### Schrödinger's Spell (Path of Paradox)
...
### Chaotic Evil (Path of Pandemonium)
...
**Effect:** Each round, gain random defense:
- +5 AC vs one attack
